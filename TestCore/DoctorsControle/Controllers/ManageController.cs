...
using DAL.Models;
using DAL.Models.ManageViewModels;
...
namespace DoctorsControle.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            user.Age = model.Age;
            user.CurrentWorkPlace = model.CurrentWorkPlace;
            user.Educations = model.Educations;
            user.Information = model.Information;
            user.JobTitle = model.JobTitle;
            user.Location = model.Location;
            user.PreviousExperience = model.PreviousExperience;
            user.Procedures = model.Procedures;
            ...
            //    Age = model.Age,
            //    CurrentWorkPlace = model.CurrentWorkPlace,
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("DoctorsControle"),
